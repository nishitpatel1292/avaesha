...
const Input = React.forwardRef(
  (
    ...
    return (
      <>
        <div
          className={`${className} flex items-center justify-center md:w-full text-white-A700 rounded-tl-[10px] rounded-bl-[10px] text-base font-medium bg-white-A700_33 ${shapes[shape] || ""} ${variants[variant]?.[color] || variants[variant] || ""} ${sizes[size] || ""}`}
        >
          {!!label && label}
          {!!prefix && prefix}
